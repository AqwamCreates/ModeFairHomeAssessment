...
wait(1) -- These wait function are here because Roblox Studio sets a limit on how long the function can run. So if you're using pure Luau compiler, you wouldn't have this issue.
